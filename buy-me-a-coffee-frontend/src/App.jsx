  ...
  return (
    <div className={styles.container}>
      ...
      {currentAccount && (memos.map((memo, idx) => {
        const dateString =  new Date(memo.timestamp.toNumber()*1000).toString()
        let message 
        try {
          message = memo.message.toString()
        } catch (error) {
        ...
        return (
          <div key={idx} style={{border:"2px solid", "borderRadius":"5px", padding: "5px", margin: "5px"}}>
            ...
            <p>From: {memo.name} at {dateString}</p>
          </div>
        )
      }))}
      ...
      <footer className={styles.footer}>
        <a
          href="https://github.com/chenym1992/road-to-web3"
          target="_blank"
